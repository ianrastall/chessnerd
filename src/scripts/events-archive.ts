...
const search = document.querySelector<HTMLInputElement>('#evSearch')!;
const pageSize = document.querySelector<HTMLSelectElement>('#evPageSize')!;
const previous = document.querySelector<HTMLButtonElement>('#evPrevPage')!;
const next = document.querySelector<HTMLButtonElement>('#evNextPage')!;
const status = document.querySelector<HTMLElement>('#evStatus')!;
const pageInfo = document.querySelector<HTMLElement>('#evPageInfo')!;
const empty = document.querySelector<HTMLTableRowElement>('#evEmpty')!;
const rows = Array.from(document.querySelectorAll<HTMLTableRowElement>('[data-ev-entry]'));
let currentPage = 1;
...
render();
document.querySelector<HTMLElement>('#evControls')!.hidden = false;
document.querySelector<HTMLElement>('#evPagination')!.hidden = false;
